<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site2.Master" AutoEventWireup="true" CodeBehind="billing.aspx.cs" Inherits="HMS_Portel.User.billing" %>
...
<head>
	...
	<title>Hospital Panel · Billing</title>
	<link rel="stylesheet" href="styles.css" />
</head>
<body>
	<div class="app">
		<aside class="sidebar">
			<div class="brand"><div class="logo"></div> Hospital Panel</div>
			<nav class="nav">
		...
		<main class="content">
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>$80.00</td>
							<td><span class="pill success">Paid</span></td>
						</tr>
						<tr>
							<td>INV-1055</td>
							<td>Oct 03, 2025</td>
			...
			<div class="footer">Questions? Contact billing@hospital.example</div>
		</main>
	</div>
</body>
</html>
