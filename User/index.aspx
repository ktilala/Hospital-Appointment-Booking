<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site2.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="HMS_Portel.User.index" %>
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="topbar">
                    ...
                    <div class="user-mini">
                        <div class="muted">Welcome, User</div>
                ...
                <div class="footer">© 2025 Hospital Panel. All rights reserved.</div>
            </main>
        </div>
    </body>
    </html>
        ...
        <div class="app">
            <aside class="sidebar">
                <div class="brand">
                    ...
                    Hospital Panel</div>
                <nav class="nav">
                    <a class="active" href="index.aspx"><span class="i">🏠</span> Dashboard</a> <a href="book-appointment.html"><span class="i">🗓️</span> Book Appointment</a> <a href="my-appointments.html"><span class="i">📋</span> My Appointments</a> <a href="doctors.html"><span class="i">👩‍⚕️</span> Doctors</a> <a href="billing.html"><span class="i">💳</span> Billing</a>
                    <div class="sep">
                    </div>
                    <a href="profile.aspx"><span class="i">👤</span> Profile</a>
                </nav>
