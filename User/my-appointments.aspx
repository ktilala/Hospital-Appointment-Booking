<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site2.Master" AutoEventWireup="true" CodeBehind="my-appointments.aspx.cs" Inherits="HMS_Portel.User.my_appointments" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <head>
        ...
        <title>Hospital Panel · My Appointments</title>
    ...
    <body>
        <div class="app">
            ...
            <main class="content">
                ...
                <center>
                    <h1><asp:Label ID="lblMessage" runat="server" Text="Label"></asp:Label></h1>
