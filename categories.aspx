<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="categories.aspx.cs" Inherits="HMS_Portel.categories" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder1">
      <section class="admin-buses">
          <div class="container">
              <div class="card">
                  <h2 class="title">Add Medicine Category</h2>
                  <div class="form-box">
                      <label class="label-text">Category Name</label>
                      <asp:TextBox ID="txtmct" runat="server" CssClass="input-text"></asp:TextBox>
                  </div>
                  <div class="form-box">
                      <asp:Button ID="Button1" runat="server" Text="Add" CssClass="btn" OnClick="Button1_Click" />
                  </div>
              </div>
